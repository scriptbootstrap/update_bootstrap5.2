...
// ============================================
// query table PIBU berdasarkan URL [0]
// ============================================
if (isset($_GET["id_pibu"])) {
	$idPIBU = $_GET["id_pibu"];
	$queryIdPIBU = query("SELECT * FROM tb_pibu WHERE id = '$idPIBU' ")[0];
}
...
<head>
	...
	<title>Edit Pakta Integritas Badan Usaha - SiKuDa BaJa</title>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Edit Pakta Integritas Badan Usaha</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="pibu">Data Pakta Integritas Badan Usaha</a>
							</li>
							<li class="separator">
								<i class="flaticon-right-arrow"></i>
							</li>
							<li class="nav-item">
								<a href="#">Edit Pakta Integritas Badan Usaha</a>
							</li>
						</ul>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="card card-form">
								<form action="../barang-jasa" method="post" class="user" enctype="multipart/form-data">
									<input type="text" hidden name="id" value="<?= $queryIdPIBU["id"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_wakil_penyedia" name="nama_wakil_penyedia" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdPIBU["nama_wakil_penyedia"] ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="jabatan" name="jabatan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdPIBU["jabatan"] ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="alamat_perusahaan" name="alamat_perusahaan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdPIBU["alamat_perusahaan"] ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_perusahaan" name="nama_perusahaan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdPIBU["nama_perusahaan"] ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_pekerjaan" name="nama_pekerjaan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdPIBU["nama_pekerjaan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input list="nama_satker" name="nama_satker" class="form-control input-border-bottom" required oninvalid="this.setCustomValidity('nama_satker harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off" value="<?= $queryIdPIBU["nama_satker"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="tahun_anggaran" name="tahun_anggaran" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdPIBU["tahun_anggaran"]; ?>">
									...
									<div class="card-body row">
										<div class="form-group btn-form form-floating-label col-sm-6 mb-3 mb-sm-0">
											<button type="submit" name="edit_pibu" class="btn bg-skb-3">SIMPAN <i class="fa fa-save"></i></button>
