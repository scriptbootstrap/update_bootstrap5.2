...
<head>
	...
	<title>Buat Pakta Integritas Badan Usaha - SiKuDa BaJa</title>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Buat Pakta Integritas Badan Usaha</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#">Buat Pakta Integritas Badan Usaha</a>
							</li>
						</ul>
					</div>
					<div class="row">
								...
								<form action="../barang-jasa" method="post" class="user" enctype="multipart/form-data">
									...
									<div class="card-body row">
										<div class="form-group btn-form form-floating-label col-sm-6 mb-3 mb-sm-0">
											<button type="submit" name="pibu" class="btn bg-skb-3">SIMPAN <i class="fa fa-save"></i></button>
