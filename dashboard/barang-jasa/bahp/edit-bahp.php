...
// ============================================
// query table BAHP berdasarkan URL [0]
// ============================================
if (isset($_GET["id_bahp"])) {
	$idBAHP = $_GET["id_bahp"];
	$queryIdBAHP = query("SELECT * FROM tb_bahp WHERE id = '$idBAHP' ")[0];
}
...
<head>
	...
	<title>Edit Berita Acara Hasil Pengadaan Langsung - SiKuDa BaJa</title>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Edit Berita Acara Hasil Pengadaan Langsung</h4>
						...
						<div class="col-md-12">
							<div class="card card-form">
								<form action="../barang-jasa" method="post" class="user" enctype="multipart/form-data">
									<input type="text" hidden name="id" value="<?= $queryIdBAHP["id"]; ?>">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											...
											<input id="tgl_surat" name="tgl_surat" type="date" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHP["tgl_surat"]; ?>">
										</div>
									</div>

									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="no_kegiatan" name="no_kegiatan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHP["no_kegiatan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input list="nama_satker" name="nama_satker" class="form-control input-border-bottom" required oninvalid="this.setCustomValidity('nama_satker harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off" value="<?= $queryIdBAHP["nama_satker"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_perusahaan" name="nama_perusahaan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHP["nama_perusahaan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="alamat_perusahaan" name="alamat_perusahaan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHP["alamat_perusahaan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nomor_npwp" name="nomor_npwp" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHP["nomor_npwp"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_pekerjaan" name="nama_pekerjaan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHP["nama_pekerjaan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="tahun_anggaran" name="tahun_anggaran" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHP["tahun_anggaran"]; ?>">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="kode_rup" name="kode_rup" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHP["kode_rup"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="jmlh_penawaran" name="harga_penawaran" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHP["harga_penawaran"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="jmlh_negosiasi" name="harga_negosiasi" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHP["harga_negosiasi"]; ?>">
											<label for="jmlh_negosiasi" class="placeholder"><i class="bi bi-cash"></i> Harga Negosiasi</label>
										</div>
									</div>

									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nomor_dipa" name="nomor_dipa" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHP["nomor_dipa"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											...
											<input id="tgl_dipa" name="tgl_dipa" type="date" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHP["tgl_dipa"]; ?>">
										</div>
									</div>
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<select name="nama_pp" id="nama_pp" class="form-control input-border-bottom" required oninvalid="this.setCustomValidity('Bidang ini harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off">
												<option value="<?= $queryIdBAHP["nama_pp"]; ?>"><?= $queryIdBAHP["nama_pp"]; ?></option>
									...
									<div class="card-body row">
										<div class="form-group btn-form form-floating-label col-sm-6 mb-3 mb-sm-0">
											<button type="submit" name="edit_bahp" class="btn bg-skb-3">SIMPAN <i class="fa fa-save"></i></button>
