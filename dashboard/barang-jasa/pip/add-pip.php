...
<head>
	...
	<title>Buat Pakta Integritas Perorangan - SiKuDa BaJa</title>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Buat Pakta Integritas Perorangan</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#">Buat Pakta Integritas Perorangan</a>
							</li>
						</ul>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="card card-form">
								<form action="../barang-jasa" method="post" class="user" enctype="multipart/form-data">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="no_identitas" name="no_identitas" type="text" class="form-control input-border-bottom" required="">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="alamat_ktp" name="alamat_ktp" type="text" class="form-control input-border-bottom" required="">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="pekerjaan" name="pekerjaan" type="text" class="form-control input-border-bottom" required="">
									...
									<div class="card-body row">
										<div class="form-group btn-form form-floating-label col-sm-6 mb-3 mb-sm-0">
											<button type="submit" name="pip" class="btn bg-skb-3">SIMPAN <i class="fa fa-save"></i></button>
