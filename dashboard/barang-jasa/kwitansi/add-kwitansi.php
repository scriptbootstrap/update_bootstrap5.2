...
<head>
	...
	<title>Buat Kwitansi/Bukti Pembayaran - SiKuDaBaJa</title>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Buat Kwitansi/Bukti Pembayaran</h4>
								...
								<form action="../barang-jasa" method="post" class="user" enctype="multipart/form-data">
									...
									<div class="card-body row">
										<div class="form-group btn-form form-floating-label col-sm-6 mb-3 mb-sm-0">
											<button type="submit" name="kwitansi" class="btn bg-skb-3">SIMPAN <i class="fa fa-save"></i></button>
