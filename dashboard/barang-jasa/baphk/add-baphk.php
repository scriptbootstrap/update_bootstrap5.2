...
<head>
	...
	<title>Buat Berita Acara Penetapan Hasil Kualifikasi - SiKuDa BaJa</title>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Buat Berita Acara Penetapan Hasil Kualifikasi</h4>
						...
						<div class="col-md-12">
							<div class="card card-form">
								<form action="../barang-jasa" method="post" class="user" enctype="multipart/form-data">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input list="nama_satker" name="nama_satker" class="form-control input-border-bottom" required oninvalid="this.setCustomValidity('Nama satker harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off" value="<?= $queryIdBarangJasa["nama_satker"]; ?>">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="no_izin_usaha" name="no_izin_usaha" type="text" class="form-control input-border-bottom" required="">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											...
											<input id="tgl_terbit_nib" name="tgl_terbit_nib" type="date" class="form-control input-border-bottom" required="">
										</div>
									</div>
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input type="radio" id="noCheck" name="perubahan_ke" onchange="yesnoCheck()">
											<label for="noCheck">--- Tidak Ada Perubahan ---</label>
											<br>
											<input type="radio" id="yesCheck" name="perubahan_ke" onchange="yesnoCheck()">
											<label for="yesCheck">--- Ada Perubahan ---</label>
										</div>
									</div>


									<div class="form-add" id="ifYes" style="display: none;">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="perubahan_ke" name="perubahan_ke" type="text" class="form-control input-border-bottom" placeholder="1">
									...
									<div class="card-body row">
										<div class="form-group btn-form form-floating-label col-sm-6 mb-3 mb-sm-0">
											<button type="submit" name="baphk" class="btn bg-skb-3">SIMPAN <i class="fa fa-save"></i></button>
