...
// ============================================
// query table BAPHK berdasarkan URL [0]
// ============================================
if (isset($_GET["id_baphk"])) {
	$idBAPHK = $_GET["id_baphk"];
	$queryIdBAPHK = query("SELECT * FROM tb_baphk WHERE id = '$idBAPHK' ")[0];
}
...
<head>
	...
	<title>Edit Berita Acara Penetapan Hasil Kualifikasi - SiKuDa BaJa</title>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Edit Berita Acara Penetapan Hasil Kualifikasi</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="baphk">Data Berita Acara Penetapan Hasil Kualifikasi</a>
							</li>
							<li class="separator">
								<i class="flaticon-right-arrow"></i>
							</li>
						...
						<div class="col-md-12">
							<div class="card card-form">
								<form action="../barang-jasa" method="post" class="user" enctype="multipart/form-data">
									<input type="text" hidden name="id" value="<?= $queryIdBAPHK["id"]; ?>">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											...
											<input id="tgl_surat" name="tgl_surat" type="date" class="form-control input-border-bottom" required="" value="<?= $queryIdBAPHK["tgl_surat"]; ?>">
										</div>
									</div>

									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="no_kegiatan" name="no_kegiatan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAPHK["no_kegiatan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input list="nama_satker" name="nama_satker" class="form-control input-border-bottom" required oninvalid="this.setCustomValidity('Nama satker harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off" value="<?= $queryIdBAPHK["nama_satker"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_perusahaan" name="nama_perusahaan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAPHK["nama_perusahaan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="alamat_perusahaan" name="alamat_perusahaan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAPHK["alamat_perusahaan"]; ?>">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="no_izin_usaha" name="no_izin_usaha" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAPHK["no_izin_usaha"]; ?>">
											<label for="no_izin_usaha" class="placeholder"><i class="bi bi-2-square-fill"></i> Nomor Izin Usaha/NIB</label>
										</div>
									</div>

									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<label for="tgl_terbit_nib"><i class="bi bi-calendar2-date-fill"></i> Tanggal Penerbitan NIB</label>
											<input id="tgl_terbit_nib" name="tgl_terbit_nib" type="date" class="form-control input-border-bottom" required="" value="<?= $queryIdBAPHK["tgl_terbit_nib"]; ?>">
										</div>
									</div>

									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="perubahan_ke" name="perubahan_ke" type="text" class="form-control input-border-bottom" value="<?= $queryIdBAPHK["perubahan_ke"]; ?>">
											<label for="perubahan_ke" class="placeholder"><i class="bi bi-3-square-fill"></i> Perubahan Ke</label>
											<span>Note: Jika tidak ada perubahan dikosongkan saja</span>
										</div>
									</div>

									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nomor_npwp" name="nomor_npwp" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAPHK["nomor_npwp"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_pekerjaan" name="nama_pekerjaan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAPHK["nama_pekerjaan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="tahun_anggaran" name="tahun_anggaran" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAPHK["tahun_anggaran"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<select name="nama_pp" id="nama_pp" class="form-control input-border-bottom" required oninvalid="this.setCustomValidity('Bidang ini harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off">
												<option value="<?= $queryIdBAPHK["nama_pp"]; ?>"><?= $queryIdBAPHK["nama_pp"]; ?></option>
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_wakil_penyedia" name="nama_wakil_penyedia" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAPHK["nama_wakil_penyedia"]; ?>">
									...
									<div class="card-body row">
										<div class="form-group btn-form form-floating-label col-sm-6 mb-3 mb-sm-0">
											<button type="submit" name="edit_baphk" class="btn bg-skb-3">SIMPAN <i class="fa fa-save"></i></button>
