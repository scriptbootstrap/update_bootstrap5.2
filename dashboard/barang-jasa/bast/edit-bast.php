...
// ============================================
// query table bast berdasarkan URL [0]
// ============================================
if (isset($_GET["id_bast"])) {
	$idBAST = $_GET["id_bast"];
	$queryIdBAST = query("SELECT * FROM tb_bast WHERE id = '$idBAST' ")[0];
}
...
// query table surat bapp
$resultBapp = query("SELECT * FROM tb_bapp");
...
<head>
	...
	<title>Edit Berita Acara Serah Terima - SiKuDaBaJa</title>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Edit Berita Acara Serah Terima</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="bast">Data Berita Acara Serah Terima</a>
							</li>
							<li class="separator">
								<i class="flaticon-right-arrow"></i>
							</li>
						...
						<div class="col-md-12">
							<div class="card card-form">
								<form action="../barang-jasa" method="post" class="user" enctype="multipart/form-data">
									<input type="text" hidden name="id" value="<?= $queryIdBAST["id"]; ?>">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											...
											<input id="tgl_surat" name="tgl_surat" type="date" class="form-control input-border-bottom" required="" value="<?= $queryIdBAST["tgl_surat"]; ?>">
										</div>
									</div>

									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="no_kegiatan" name="no_kegiatan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAST["no_kegiatan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input list="nama_satker" name="nama_satker" class="form-control input-border-bottom" required oninvalid="this.setCustomValidity('nama_satker harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off" value="<?= $queryIdBAST["nama_satker"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="alamat_satker" name="alamat_satker" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAST["alamat_satker"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_perusahaan" name="nama_perusahaan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAST["nama_perusahaan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="alamat_perusahaan" name="alamat_perusahaan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAST["alamat_perusahaan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_pekerjaan" name="nama_pekerjaan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAST["nama_pekerjaan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="tahun_anggaran" name="tahun_anggaran" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAST["tahun_anggaran"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_wakil_penyedia" name="nama_wakil_penyedia" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAST["nama_wakil_penyedia"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="jabatan" name="jabatan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAST["jabatan"]; ?>">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											...
											<select id="jenis_surat" name="jenis_surat" class="form-control input-border-bottom" required oninvalid="this.setCustomValidity('Jenis surat harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off">
												<option value="<?= $queryIdBAST["jenis_surat"]; ?>">
													<?= $queryIdBAST["jenis_surat"]; ?>
												</option>
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											...
											<select id="no_jenis_surat" name="no_jenis_surat" class="form-control input-border-bottom" required oninvalid="this.setCustomValidity('Jenis surat harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off">
												...
												<option value="<?= $queryIdBAST["no_jenis_surat"]; ?>">
													<?= $queryIdBAST["no_jenis_surat"]; ?>
												</option>
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<select name="nama_ppk" id="nama_ppk" class="form-control input-border-bottom" required oninvalid="this.setCustomValidity('Bidang ini harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off">
												<option value="<?= $queryIdBAST["nama_ppk"]; ?>">
													<?= $queryIdBAST["nama_ppk"]; ?>
												</option>
									...
									<div class="card-body row">
										<div class="form-group btn-form form-floating-label col-sm-6 mb-3 mb-sm-0">
											<button type="submit" name="edit_bast" class="btn bg-skb-3">SIMPAN <i class="fa fa-save"></i></button>
