...
$noBapp = $_POST["no_bapp"];
$tglNoBapp = $_POST["tgl_no_bapp"];
...
$document = file_get_contents("bast.rtf");
...
$document = str_replace("%%no_bapp%%", $noBapp, $document);
$document = str_replace("%%tgl_no_bapp%%", $tglNoBapp, $document);
...
header("Content-disposition: inline; filename=8_PPK_BAST.doc");
