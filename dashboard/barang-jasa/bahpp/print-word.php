...
$namaPerwakilanSm = $_POST["nama_perwakilan_sm"];
$namaPetugasVerifikasiMdp = $_POST["nama_petugas_verifikasi_mdp"];
$namaPendukung1 = $_POST["nama_pendukung1"];
$namaPendukung2 = $_POST["nama_pendukung2"];
...
$document = file_get_contents("bahpp.rtf");
...
$document = str_replace("%%nama_perwakilan_sm%%", $namaPerwakilanSm, $document);
$document = str_replace("%%nama_petugas_verifikasi_mdp%%", $namaPetugasVerifikasiMdp, $document);
$document = str_replace("%%nama_pendukung1%%", $namaPendukung1, $document);
$document = str_replace("%%nama_pendukung2%%", $namaPendukung2, $document);
...
header("Content-disposition: inline; filename=7_PPK_BAHPP.doc");
