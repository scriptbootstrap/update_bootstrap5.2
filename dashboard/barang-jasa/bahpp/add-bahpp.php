...
<head>
	...
	<title>Buat Berita Acara Hasil Pemeriksaan Pekerjaan - SiKuDa BaJa</title>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Buat Berita Acara Hasil Pemeriksaan Pekerjaan</h4>
						...
						<div class="col-md-12">
							<div class="card card-form">
								<form action="../barang-jasa" method="post" class="user" enctype="multipart/form-data">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_perwakilan_sm" name="nama_perwakilan_sm" type="text" class="form-control input-border-bottom" required="">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_petugas_verifikasi_mdp" name="nama_petugas_verifikasi_mdp" type="text" class="form-control input-border-bottom" required="">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_pendukung1" name="nama_pendukung1" type="text" class="form-control input-border-bottom">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_pendukung2" name="nama_pendukung2" type="text" class="form-control input-border-bottom">
									...
									<div class="card-body row">
										<div class="form-group btn-form form-floating-label col-sm-6 mb-3 mb-sm-0">
											<button type="submit" name="bahpp" class="btn bg-skb-3">SIMPAN <i class="fa fa-save"></i></button>
