...
// ============================================
// query table BAHPP berdasarkan URL [0]
// ============================================
if (isset($_GET["id_bahpp"])) {
	$idBAHPP = $_GET["id_bahpp"];
	$queryIdBAHPP = query("SELECT * FROM tb_bahpp WHERE id = '$idBAHPP' ")[0];
}
...
<head>
	...
	<title>Edit Berita Acara Hasil Pemeriksaan Pekerjaan - SiKuDa BaJa</title>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Edit Berita Acara Hasil Pemeriksaan Pekerjaan</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="bahpp">Data Berita Acara Hasil Pemeriksaan Pekerjaan</a>
							</li>
							<li class="separator">
								<i class="flaticon-right-arrow"></i>
							</li>
						...
						<div class="col-md-12">
							<div class="card card-form">
								<form action="../barang-jasa" method="post" class="user" enctype="multipart/form-data">
									<input type="text" hidden name="id" value="<?= $queryIdBAHPP["id"]; ?>">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											...
											<input id="tgl_surat" name="tgl_surat" type="date" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHPP["tgl_surat"]; ?>">
										</div>
									</div>

									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="no_kegiatan" name="no_kegiatan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHPP["no_kegiatan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input list="nama_satker" name="nama_satker" class="form-control input-border-bottom" required oninvalid="this.setCustomValidity('nama_satker harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off" value="<?= $queryIdBAHPP["nama_satker"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="alamat_satker" name="alamat_satker" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHPP["alamat_satker"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_perusahaan" name="nama_perusahaan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHPP["nama_perusahaan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="alamat_perusahaan" name="alamat_perusahaan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHPP["alamat_perusahaan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_pekerjaan" name="nama_pekerjaan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHPP["nama_pekerjaan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="tahun_anggaran" name="tahun_anggaran" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHPP["tahun_anggaran"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_wakil_penyedia" name="nama_wakil_penyedia" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHPP["nama_wakil_penyedia"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="jabatan" name="jabatan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHPP["jabatan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<select name="nama_ppk" id="nama_ppk" class="form-control input-border-bottom" required oninvalid="this.setCustomValidity('Bidang ini harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off">
												<option value="<?= $queryIdBAHPP["nama_ppk"]; ?>">
													<?= $queryIdBAHPP["nama_ppk"]; ?>
												</option>
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_perwakilan_sm" name="nama_perwakilan_sm" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHPP["nama_perwakilan_sm"]; ?>">
											<label for="nama_perwakilan_sm" class="placeholder"><i class="bi bi-person-fill"></i> Nama Perwakilan SM</label>
										</div>
									</div>

									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_petugas_verifikasi_mdp" name="nama_petugas_verifikasi_mdp" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAHPP["nama_petugas_verifikasi_mdp"]; ?>">
											<label for="nama_petugas_verifikasi_mdp" class="placeholder"><i class="bi bi-person-fill"></i> Nama Petugas Verifikasi MDP</label>
										</div>
									</div>

									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_pendukung1" name="nama_pendukung1" type="text" class="form-control input-border-bottom" value="<?= $queryIdBAHPP["nama_pendukung1"]; ?>">
											<label for="nama_pendukung1" class="placeholder"><i class="bi bi-person-fill"></i> Nama Pendukung Lainnya <sup>(Jika Dibutuhkan)</sup></label>
										</div>
									</div>

									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_pendukung2" name="nama_pendukung2" type="text" class="form-control input-border-bottom" value="<?= $queryIdBAHPP["nama_pendukung2"]; ?>">
											<label for="nama_pendukung2" class="placeholder"><i class="bi bi-person-fill"></i> Nama Pendukung Lainnya <sup>(Jika Dibutuhkan)</sup></label>
										</div>
									</div>
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											...
											<select id="jenis_surat" name="jenis_surat" class="form-control input-border-bottom" required oninvalid="this.setCustomValidity('Jenis surat harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off">
												<option value="<?= $queryIdBAHPP["jenis_surat"]; ?>">
													<?= $queryIdBAHPP["jenis_surat"]; ?>
												</option>
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											...
											<select id="no_jenis_surat" name="no_jenis_surat" class="form-control input-border-bottom" required oninvalid="this.setCustomValidity('Jenis surat harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off">
												...
												<option value="<?= $queryIdBAHPP["no_jenis_surat"]; ?>">
													<?= $queryIdBAHPP["no_jenis_surat"]; ?>
												</option>
									...
									<div class="card-body row">
										<div class="form-group btn-form form-floating-label col-sm-6 mb-3 mb-sm-0">
											<button type="submit" name="edit_bahpp" class="btn bg-skb-3">SIMPAN <i class="fa fa-save"></i></button>
