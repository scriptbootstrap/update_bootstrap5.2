...
$noBast = $_POST["no_bast"];
$tglNoBast = $_POST["tgl_no_bast"];
...
$document = file_get_contents("bap.rtf");
...
$document = str_replace("%%no_bast%%", $noBast, $document);
$document = str_replace("%%tgl_no_bast%%", $tglNoBast, $document);
...
header("Content-disposition: inline; filename=9_PPK_BAP.doc");
