...
// ============================================
// query table bap berdasarkan URL [0]
// ============================================
if (isset($_GET["id_bap"])) {
	$idBAP = $_GET["id_bap"];
	$queryIdBAP = query("SELECT * FROM tb_bap WHERE id = '$idBAP' ")[0];
}
...
// query table surat bast
$resultBast = query("SELECT * FROM tb_bast");
...
<head>
	...
	<title>Edit Berita Acara Pembayaran - SiKuDaBaJa</title>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Edit Berita Acara Pembayaran</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="bap">Data Berita Acara Pembayaran</a>
							</li>
							<li class="separator">
								<i class="flaticon-right-arrow"></i>
							</li>
						...
						<div class="col-md-12">
							<div class="card card-form">
								<form action="../barang-jasa" method="post" class="user" enctype="multipart/form-data">
									<input type="text" hidden name="id" value="<?= $queryIdBAP["id"]; ?>">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											...
											<input id="tgl_surat" name="tgl_surat" type="date" class="form-control input-border-bottom" required="" value="<?= $queryIdBAP["tgl_surat"]; ?>">
										</div>
									</div>

									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="no_kegiatan" name="no_kegiatan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAP["no_kegiatan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input list="nama_satker" name="nama_satker" class="form-control input-border-bottom" required oninvalid="this.setCustomValidity('nama_satker harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off" value="<?= $queryIdBAP["nama_satker"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="alamat_satker" name="alamat_satker" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAP["alamat_satker"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_perusahaan" name="nama_perusahaan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAP["nama_perusahaan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="alamat_perusahaan" name="alamat_perusahaan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAP["alamat_perusahaan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_pekerjaan" name="nama_pekerjaan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAP["nama_pekerjaan"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="tahun_anggaran" name="tahun_anggaran" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAP["tahun_anggaran"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="nama_wakil_penyedia" name="nama_wakil_penyedia" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAP["nama_wakil_penyedia"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="jabatan" name="jabatan" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAP["jabatan"]; ?>">
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<br>
											<select id="no_bast" name="no_bast" class="form-control input-border-bottom" required oninvalid="this.setCustomValidity('Jenis surat harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off">

												<option value="<?= $queryIdBAP["no_bast"]; ?>">
													<?= $queryIdBAP["no_bast"]; ?>
												</option>

												<?php foreach ($resultBast as $row) : ?>
											...
											<label for="no_bast" class="placeholder"><i class="bi bi-envelope-fill mb-2"></i> Nomor BAST</label>
										</div>
									</div>
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											...
											<select id="jenis_surat" name="jenis_surat" class="form-control input-border-bottom" required oninvalid="this.setCustomValidity('Jenis surat harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off">
												<option value="<?= $queryIdBAP["jenis_surat"]; ?>">
													<?= $queryIdBAP["jenis_surat"]; ?>
												</option>
									...
									<div class="form-add">
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											...
											<select id="no_jenis_surat" name="no_jenis_surat" class="form-control input-border-bottom" required oninvalid="this.setCustomValidity('Jenis surat harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off">
												...
												<option value="<?= $queryIdBAP["no_jenis_surat"]; ?>">
													<?= $queryIdBAP["no_jenis_surat"]; ?>
												</option>
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="no_dipa" name="no_dipa" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBAP["no_dipa"]; ?>">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											...
											<input id="tgl_dipa" name="tgl_dipa" type="date" class="form-control input-border-bottom" required="" value="<?= $queryIdBAP["tgl_dipa"]; ?>">
										</div>
									</div>

									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="jmlh_penawaran" name="pembayaran_resmi" type="text" class="form-control input-border-bottom filled" required="" value="<?= $queryIdBAP["pembayaran_resmi"]; ?>">
											<label for="jmlh_penawaran" class="placeholder"><i class="bi bi-cash-stack"></i> Pembayaran Resmi</label>
										</div>
									</div>
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<select name="nama_ppk" id="nama_ppk" class="form-control input-border-bottom" required oninvalid="this.setCustomValidity('Bidang ini harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off">
												<option value="<?= $queryIdBAP["nama_ppk"]; ?>">
													<?= $queryIdBAP["nama_ppk"]; ?>
												</option>
									...
									<div class="card-body row">
										<div class="form-group btn-form form-floating-label col-sm-6 mb-3 mb-sm-0">
											<button type="submit" name="edit_bap" class="btn bg-skb-3">SIMPAN <i class="fa fa-save"></i></button>
