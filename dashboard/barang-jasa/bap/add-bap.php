...
<head>
	...
	<title>Buat Berita Acara Pembayaran - SiKuDaBaJa</title>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Buat Berita Acara Pembayaran</h4>
						...
						<div class="col-md-12">
							<div class="card card-form">
								<form action="../barang-jasa" method="post" class="user" enctype="multipart/form-data">
									...
									<div class="form-add" hidden>
										<div class="form-group form-floating-label col-sm-6 mb-2 mb-sm-0">
											<input id="no_dipa" name="no_dipa" type="text" class="form-control input-border-bottom" required="" value="<?= $queryIdBarangJasa["no_dipa"]; ?>">
									...
									<div class="card-body row">
										<div class="form-group btn-form form-floating-label col-sm-6 mb-3 mb-sm-0">
											<button type="submit" name="bap" class="btn bg-skb-3">SIMPAN <i class="fa fa-save"></i></button>
